  ...
  <div class="sign-up-input">
    <div class="bd-example pt-3">
      ...
      <div class="d-flex">
        ...
        <button type="button" class="btn btn-secondary" style="margin-left: 10px;width: 100px">중복확인</button>
      </div>
    </div>
    ...
    <div class="bd-example pt-3">
      ...
      <input type="email" class="form-control" id="exampleFormControlInput1" placeholder="emailaddress@example.com">
    </div>
